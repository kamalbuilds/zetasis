...
function CreateToken() {
  ...
  const { data: lastTokenId } = useContractRead({
    address:
      (process.env.NEXT_PUBLIC_ZETASIS_COLLECTION_ADDRESS as `0x${string}`) ??
      "0xB499Bc2AD48b86fd4AA9C94e081C213eDFD4bDf2",
    abi: ZetasisNFT.abi,
    ...
    return (
      <main className={styles.main}>
        <VStack>
          ...
          <HStack>
            <ChakraLink
              href={`https://explorer.athens.zetachain.com/cc/tx/${txnHash}`}
              isExternal
            >
          ...
          <VStack alignItems="flex-end" gap={1}>
            ...
            <VStack alignItems="flex-start">
              ...
              <Input
                ...
                value={collection}
                placeholder="Zetasis Collection (default) "
              ></Input>
            </VStack>
            <VStack alignItems="flex-start">
              <Text>Royalties</Text>
    ...
    return (
      <main className={styles.main}>
        <VStack>
          ...
          <HStack>
            <ChakraLink
              href={`https://explorer.athens.zetachain.com/address/${publishedContract}`}
              isExternal
            >
